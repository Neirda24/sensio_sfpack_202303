 ...
 */
final class Version20230309092106 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '[User] Added date of birth.';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD COLUMN date_of_birth DATETIME NOT NULL');
    }
